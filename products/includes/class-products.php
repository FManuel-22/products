 ...
 * @package    Products
 * @subpackage Products/includes
 * @author     Olufemi Emmanuel <uniqueinnovator924@gmail.com>
 */
class Products {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Products_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Products_Loader. Orchestrates the hooks of the plugin.
	 * - Products_i18n. Defines internationalization functionality.
	 * - Products_Admin. Defines all hooks for the admin area.
	 * - Products_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Products_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Products_Loader    Orchestrates the hooks of the plugin.
	 */
